...
AUTHOR_NAME="Atef Arfaoui"
AUTHOR_EMAIL="arfatef@gmail.com"
KEYWORDS="Technical challenge for BE"
DESCRIPTION="Example description."

GIT_REPO_DOMAIN="github.com"
GIT_REPO_NAMESPACE="technical_challenge_be"
PACKAGE_NAME="technical-challlenge-be"

# PACKAGE_VERSION="v201907.0003-alpha"
...
SUPPORTED_PYTHON_VERSIONS="python=2.7 python=3.7"
...
if ! [[ -f "$PROJECT_DIR/scripts/bootstrapit_update.sh" ]]; then
    ...
    RAW_FILES_URL="https://gitlab.com/arfatef/bootstrapit/raw/master";
